...
# Item_Stack 字体生成 PowerShell 脚本
# 自动化完成从BMFont生成到格式转换的全过程
...
$FontFile = "$OutputDir\Item_Stack.fnt"
$TxtFile = "$OutputDir\Item_Stack.txt"
...
Write-Host "`n========================================"
Write-Host "所有任务完成！"
Write-Host "输出目录: $((Resolve-Path $OutputDir).Path)"
Write-Host "========================================"
